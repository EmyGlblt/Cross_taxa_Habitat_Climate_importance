...
inputfile = paste0("WintGtest", scale, "_models_thin_", thin, "_samples_", samples, "_chains_", nChains, ".Rdata") 
load(file = inputfile)
...
filename_out = paste("WintGtestperfAB", scale, "_MF_models_thin_", as.character(thin),
