...
setwd("/home/local/guilbaul/tsclient/D/Helsinki/RECcII_project/CSC_HMSC/fullmodel/Results")
...
load('WintGtest2Ord_ch1_models_thin_1000_samples_250_chainsN1_1.Rdata')
modelsN1 = models
load('WintGtest2Ord_ch2_models_thin_1000_samples_250_chainsN1_1.Rdata')
modelsN2 = models
load('WintGtest2Ord_ch3_models_thin_1000_samples_250_chainsN1_1.Rdata')
modelsN3 = models
load('WintGtest2Ord_ch4_models_thin_1000_samples_250_chainsN1_1.Rdata')
modelsN4 = models
...
load('WintGtest3_ch1_models_thin_1000_samples_250_chainsN1_1.Rdata')
modelsN1 = models
load('WintGtest3_ch2_models_thin_1000_samples_250_chainsN1_1.Rdata')
modelsN2 = models
load('WintGtest3_ch3_models_thin_1000_samples_250_chainsN1_1.Rdata')
modelsN3 = models
load('WintGtest3_ch4_models_thin_1000_samples_250_chainsN1_1.Rdata')
modelsN4 = models
...
load('bftestOrd_ch1_models_thin_1000_samples_250_chains_1.Rdata')
modelsN1 = models
load('bftestOrd_ch2_models_thin_1000_samples_250_chains_1.Rdata')
modelsN2 = models
load('bftestOrd_ch3_models_thin_1000_samples_250_chains_1.Rdata')
modelsN3 = models
load('bftestOrd_ch4_models_thin_1000_samples_250_chains_1.Rdata')
modelsN4 = models
...
load('bftest2_ch1_models_thin_1000_samples_250_chains_1.Rdata')
modelsN1 = models
load('bftest2_ch2_models_thin_1000_samples_250_chains_1.Rdata')
modelsN2 = models
load('bftest2_ch3_models_thin_1000_samples_250_chains_1.Rdata')
modelsN3 = models
load('bftest2_ch4_models_thin_1000_samples_250_chains_1.Rdata')
modelsN4 = models
...
load('MothTest2Ord_ch1_models_thin_1000_samples_250_chains_1.Rdata')
modelsN1 = models
load('MothTest2Ord_ch2_models_thin_1000_samples_250_chains_1.Rdata')
modelsN2 = models
load('MothTest2Ord_ch3_models_thin_1000_samples_250_chains_1.Rdata')
modelsN3 = models
load('MothTest2Ord_ch4_models_thin_1000_samples_250_chains_1.Rdata')
modelsN4 = models
...
load('MothTest3_ch1_models_thin_1000_samples_250_chains_1.Rdata')
modelsN1 = models
load('MothTest3_ch2_models_thin_1000_samples_250_chains_1.Rdata')
modelsN2 = models
load('MothTest3_ch3_models_thin_1000_samples_250_chains_1.Rdata')
modelsN3 = models
load('MothTest3_ch4_models_thin_1000_samples_250_chains_1.Rdata')
modelsN4 = models
...
load('Birdtest2Ord_ch1_models_thin_1000_samples_250_chains_1.Rdata')
modelsN1 = models
load('Birdtest2Ord_ch2_models_thin_1000_samples_250_chains_1.Rdata')
modelsN2 = models
load('Birdtest2Ord_ch3_models_thin_1000_samples_250_chains_1.Rdata')
modelsN3 = models
load('Birdtest2Ord_ch4_models_thin_1000_samples_250_chains_1.Rdata')
modelsN4 = models
...
load('Birdtest3_ch1_models_thin_1000_samples_250_chains_1.Rdata')
modelsN1 = models
load('Birdtest3_ch2_models_thin_1000_samples_250_chains_1.Rdata')
modelsN2 = models
load('Birdtest3_ch3_models_thin_1000_samples_250_chains_1.Rdata')
modelsN3 = models
load('Birdtest3_ch4_models_thin_1000_samples_250_chains_1.Rdata')
modelsN4 = models
...
## this was not done again for ordination and test 3 so I compare the older models the three types not the new one use in the manuscript with the other two. 
load('Rodtest1_models_thin_1000_samples_250_chains_4.Rdata')
...
VP.test1g = computeVarPartSummaries(hM = models[[1]], exclude = 2, group = group1,
                                    groupnames = groupnames1,conditional = FALSE, marginal=FALSE)

#...........................................................................

load('RodtestOrd1_models_thin_1000_samples_250_chains_4.Rdata')
...
VP.testOrdg = computeVarPartSummaries(hM = models[[1]], exclude = 2, group = group1,
                                      groupnames = groupnames1,conditional = FALSE, marginal=FALSE)

#-........................................................................


load('Rodtest31_models_thin_1000_samples_250_chains_4.Rdata')
...
VP.test2g = computeVarPartSummaries(hM = models, exclude = 2, group = group1,
                                    groupnames = groupnames1,conditional = FALSE, marginal=FALSE)
...
ggplot()+  
  ...
  theme(text=element_text(size=20), #change font size of all text
        ...
        legend.text=element_text(size=20), #change font size of legend text
        legend.title=element_text(size=20)) #change font size of legend title  
le_y_continuous(limits = c(-1.2, 1.2)) + coord_flip()+ 
  labs(title = "", x = "Model",  
       y = "Variance Partition") + theme_classic() +
  theme(text=element_text(size=20), #change font size of all text
        axis.text=element_text(size=20), #change font size of axis text
