...
load(file="prepWinterGame2_April24_Strat2_1km.RDATA")
...
save(models,modelnames,file = paste0("unfitted_modelsWG", ch, ".Rdata"))
...
filename_out = paste("WintGtestApril", ch, "_models_thin_", as.character(thin),
