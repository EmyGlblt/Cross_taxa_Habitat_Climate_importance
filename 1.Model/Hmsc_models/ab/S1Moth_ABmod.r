...
load(file="prepMoth_Sept23_allSP_05km.RDATA")
...
rL.site = setPriors(rL.site, nfMax = 5)
...
save(models,modelnames,file = paste0("unfitMothab_models", ch, ".Rdata"))
...
filename_out = paste("MothAB", ch, "_models_thin_", as.character(thin),
