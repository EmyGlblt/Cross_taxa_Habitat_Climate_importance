...
# 
# rod
varr <- aperm(array(TabMF_rod$SR2, dim = c(2000L, 8L, 6L, 1L)), perm = c(4L, 3L, 2L, 1L))
dim(varr)
...
Carr <- aperm(array(TabMF_rod$SR2, dim = c(2000L, 8L, 6L, 6L)), perm = c(4L, 3L, 2L, 1L))
...
# wg
varr <- aperm(array(TabMF_wg$SR2, dim = c(1000L, 15L, 6L, 1L)), perm = c(4L, 3L, 2L, 1L))
dim(varr)
VP.test3_wg$Vnorm = varr * VP.test3_wg$Vnorm
VP.test3_wg$Vdiag = varr * VP.test3_wg$Vdiag

## Which species have large covariance and which covariance are they?
Carr <- aperm(array(TabMF_wg$SR2, dim = c(1000L, 15L, 6L, 6L)), perm = c(4L, 3L, 2L, 1L))
...
# bird
varr <- aperm(array(TabMF_bd$SR2, dim = c(1000L, 102L, 6L, 1L)), perm = c(4L, 3L, 2L, 1L))
dim(varr)
VP.test3_bd$Vnorm = varr * VP.test3_bd$Vnorm
VP.test3_bd$Vdiag = varr * VP.test3_bd$Vdiag

## Which species have large covariance and which covariance are they?
Carr <- aperm(array(TabMF_bd$SR2, dim = c(1000L, 102L, 6L, 6L)), perm = c(4L, 3L, 2L, 1L))
