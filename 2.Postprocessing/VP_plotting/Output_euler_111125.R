...
Vplot_rod = plot(VennDiag, counts = TRUE, font=1, cex=1.4, alpha=0.5,
                 fill=list(fill=c("#66C2A5", "orange3", 'yellow3', 'gray50', 'gray50', 'gray50')), 
                 counts = list(cex=5), shape ='ellipse', input = "union", key = TRUE,#factor_names = TRUE,
                 labels = list(font = 4, cex=1), quantities = list(fontsize = 12, cex=1.4, cex=1.4), main= '')
Vplot_rod


# Change quanity labels manually:
Vplot_rod$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.1$children$tag.label.1$label =  ''
Vplot_rod$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.2$children$tag.label.2$label =  ''
Vplot_rod$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.3$children$tag.label.3$label= ''
...
Vplot_bf = plot(VennDiag, counts = TRUE, font=1, cex=1.4, alpha=0.5,
                fill=list(fill=c("#66C2A5", "orange3", 'yellow3')), 
                counts = list(cex=3), shape ='ellipse', input = "union", key = TRUE,#factor_names = TRUE,
                labels = list(font = 4, cex=1), quantities = list(fontsize = 12, cex=1.4), main= '')
Vplot_bf


# Change quanity labels manually:

Vplot_bf$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.1$children$tag.label.1$label= ''
Vplot_bf$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.2$children$tag.label.2$label= ''
Vplot_bf$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.3$children$tag.label.3$label= ''
...
Vplot_wg = plot(VennDiag, counts = TRUE, font=1, cex=1.4, alpha=0.5,
                fill=list(fill=c("#66C2A5", "orange3", 'yellow3')), 
                counts = list(cex=3), shape ='ellipse', input = "union", key = TRUE,#factor_names = TRUE,
                labels = list(font = 4, cex=1), quantities = list(fontsize = 12, cex=1.4), main= '')
Vplot_wg
...
Vplot_wg$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.1$children$tag.label.1$label= ''
Vplot_wg$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.2$children$tag.label.2$label= ''
Vplot_wg$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.3$children$tag.label.3$label= ''
...
Vplot_bird = plot(VennDiag, counts = TRUE, font=1, cex=1.4, alpha=0.5,
...
Vplot_bird$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.1$children$tag.label.1$label= ''
Vplot_bird$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.2$children$tag.label.2$label= ''
Vplot_bird$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.3$children$tag.label.3$label= ''
...
Vplot_moth = plot(VennDiag, counts = TRUE, font=1, cex=1.4, alpha=0.5,
...
Vplot_moth$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.1$children$tag.label.1$label= ''
Vplot_moth$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.2$children$tag.label.2$label= ''
Vplot_moth$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.3$children$tag.label.3$label= ''
...
# create the legend one

VennDiag <- euler(c("Climate" = 5, "Habitat composition" = 5, "Landscape configuration" = 5, 
                    "Climate&Habitat composition" = 0.5, "Habitat composition&Landscape configuration" = 0.5, 
                    "Climate&Landscape configuration" = 0.5, "Climate&Habitat composition&Landscape configuration" = 0),
                  control = list(extraopt = FALSE))
...
Vplot_test = plot(VennDiag, counts = TRUE, font=1, cex=1.4, alpha=0.5,
                  fill=list(fill=c("#66C2A5", "orange3", 'yellow3', '#ACA560', '#A6C769', '#CFA900')), 
                  counts = list(cex=3), shape ='ellipse', input = "union", key = TRUE,#factor_names = TRUE,
                  labels = list(font = 4, cex=3), quantities = list(fontsize = 12, cex=1.4), main= '')
Vplot_test

Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.1$children$tag.label.1$label= 'Climate'
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.2$children$tag.label.2$label= 'Habitat \n composition'
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.3$children$tag.label.3$label= 'Landscape \n configuration'

Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.1$children$tag.quantity.1$label = ''
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.2$children$tag.quantity.2$label = ''
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.3$children$tag.quantity.3$label = ''
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.4$children$tag.quantity.4$label = ''
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.5$children$tag.quantity.5$label = ''
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.6$children$tag.quantity.6$label = ''
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.7$children$tag.quantity.7$label = ''

Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.1$children$tag.label.1$vjust = 2
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.2$children$tag.label.2$vjust = 1
Vplot_test$children$canvas.grob$children$diagram.grob.1$children$tags$children$tag.number.3$children$tag.label.3$vjust = 1
Vplot_test
