...
load('VPtrait_bird2.RDATA')
load('VPtrait_wg.RDATA')
load('VPtrait_moth.RDATA')

BdDat_trait$taxa = 'Bird'
BfDat_trait$taxa = 'Butterfly'
mothDat_trait$taxa = 'Moth'
rodDat_trait$taxa = 'Rodent'
wgDat_trait$taxa = 'Winter Game'

#.......................................................  Bird
BdDat_trait2 = BdDat_trait[,c(1:4, 10, 11, 29, 34)]
summary(BdDat_trait2)


### cat - body length
hist(BdDat_trait2$WingLengthMean)
BdDat_trait2$BodySize = NA
BdDat_trait2$BodySize[BdDat_trait2$WingLengthMean <= 108] = 'small'
BdDat_trait2$BodySize[BdDat_trait2$WingLengthMean > 108] = 'Large'

table(BdDat_trait2$BodySize)


### cat - generation 
BdDat_trait2$Nr_Broods_S
BdDat_trait2$Lpyear = NA
BdDat_trait2$Lpyear[BdDat_trait2$Nr_Broods_S == 1] = 'slow'
BdDat_trait2$Lpyear[BdDat_trait2$Nr_Broods_S == 2] = 'fast'

table(BdDat_trait2$Lpyear)

### cat - Hab breadth
table(BdDat_trait2$Habitat.specialism)

BdDat_trait2$Habspe = NA
BdDat_trait2$Habspe[BdDat_trait2$Habitat.specialism > 0.5] = 'specialist'
BdDat_trait2$Habspe[BdDat_trait2$Habitat.specialism <= 0.5] = 'generalist'

table(BdDat_trait2$Habspe)


# .......................................................  Moth
mothDat_trait2 = mothDat_trait[,c(1:4, 5, 8, 6, 9)]
...
hist(mothDat_trait2$Voltinism)
mothDat_trait2$Lpyear = NA
mothDat_trait2$Lpyear[mothDat_trait2$Voltinism %in% c('0', '1')] = 'slow'
mothDat_trait2$Lpyear[mothDat_trait2$Voltinism %in% c('3', '2')] = 'fast'

table(mothDat_trait2$Lpyear)


### cat - Hab breadth
table(mothDat_trait2$Diet)

mothDat_trait2$Habspe = NA
mothDat_trait2$Habspe[mothDat_trait2$Diet %in% c('monophag', 'oligophag', 'lichen', 'mushroom')] = 'specialist'
mothDat_trait2$Habspe[mothDat_trait2$Diet %in% 'polyphag'] = 'generalist'

table(mothDat_trait2$Habspe)


# ....................................................... butterfly
BfDat_trait2 = BfDat_trait
summary(BfDat_trait2)


### cat - body length
hist(BfDat_trait2$Body.size)
BfDat_trait2$BodySize = NA
BfDat_trait2$BodySize[BfDat_trait2$Body.size <= 37] = 'small'
BfDat_trait2$BodySize[BfDat_trait2$Body.size > 37] = 'Large'

table(BfDat_trait2$BodySize)


### cat - generation per year
hist(BfDat_trait2$Voltinism)
BfDat_trait2$Lpyear = NA
BfDat_trait2$Lpyear[BfDat_trait2$Voltinism %in% c('0', '1')] = 'slow'
BfDat_trait2$Lpyear[BfDat_trait2$Voltinism %in% c('3', '2')] = 'fast'

table(BfDat_trait2$Lpyear)


### cat - Hab breadth
table(BfDat_trait2$Breadth.of.habitat.use.adult.butterflies)

BfDat_trait2$Habspe = NA
BfDat_trait2$Habspe[BfDat_trait2$Specificity.of.larval.host.plant.use %in% c('monophagous', 'oligophagous')] = 'specialist'
BfDat_trait2$Habspe[BfDat_trait2$Specificity.of.larval.host.plant.use %in% 'polyphagous'] = 'generalist'
table(BfDat_trait2$Habspe)

BfDat_trait2 = BfDat_trait2[, c(1:5, 8, 6, 9:12)]

#.......................................................  rodents
rodDat_trait2 = rodDat_trait[,c(1:4, 6, 8, 9, 12)]
summary(rodDat_trait2)

## If group cat

### cat - body length
hist(rodDat_trait2$adult_body_length_mm)
rodDat_trait2$BodySize = NA
rodDat_trait2$BodySize[rodDat_trait2$adult_body_length_mm  <= 100] = 'small'
rodDat_trait2$BodySize[rodDat_trait2$adult_body_length_mm  > 100] = 'Large'

table(rodDat_trait2$BodySize )


### cat - Litter per year
table(rodDat_trait2$litters_per_year_n)
rodDat_trait2$Lpyear = NA
rodDat_trait2$Lpyear[rodDat_trait2$litters_per_year_n <= 2.8] = 'slow'
rodDat_trait2$Lpyear[rodDat_trait2$litters_per_year_n > 2.8] = 'fast'

table(rodDat_trait2$Lpyear)


### cat - Hab breadth
table(rodDat_trait2$habitat_breadth_n)

rodDat_trait2$Habspe = NA
rodDat_trait2$Habspe[rodDat_trait2$habitat_breadth_n %in% c('2')] = 'specialist'
rodDat_trait2$Habspe[rodDat_trait2$habitat_breadth_n %in% c('5','6','3')] = 'generalist'

table(rodDat_trait2$Habspe)


#....................................................... Winter game triangle
wgDat_trait2 = wgDat_trait[,c(1:4, 6, 8, 9, 12)]
summary(wgDat_trait2)

### cat - body length
hist(wgDat_trait2$adult_body_length_mm)
wgDat_trait2$BodySize = NA
wgDat_trait2$BodySize[wgDat_trait2$adult_body_length_mm  <= 610] = 'small'
wgDat_trait2$BodySize[wgDat_trait2$adult_body_length_mm  > 610] = 'Large'

table(wgDat_trait2$BodySize )


### cat - Litter per year
hist(wgDat_trait2$litters_per_year_n)
wgDat_trait2$Lpyear = NA
wgDat_trait2$Lpyear[wgDat_trait2$litters_per_year_n <= 1] = 'slow'
wgDat_trait2$Lpyear[wgDat_trait2$litters_per_year_n > 1] = 'fast'

table(wgDat_trait2$Lpyear)


### cat - Hab breadth
table(wgDat_trait2$habitat_breadth_n)

wgDat_trait2$Habspe = NA
wgDat_trait2$Habspe[wgDat_trait2$habitat_breadth_n <= 2] = 'specialist'
wgDat_trait2$Habspe[wgDat_trait2$habitat_breadth_n > 2] = 'generalist'

table(wgDat_trait2$Habspe)


#.......................................................
colnames(BdDat_trait2)[1:8] = c('species', 'Climate', 'habConf', 'habprop', 'BodySizeCont', 'FSlifehistCont', 'HabspeCont', 'Taxa')
colnames(BfDat_trait2)[1:8] = c('species', 'Climate', 'habConf', 'habprop', 'BodySizeCont', 'FSlifehistCont', 'HabspeCont', 'Taxa')
colnames(mothDat_trait2)[1:8] = c('species', 'Climate', 'habConf', 'habprop', 'BodySizeCont', 'FSlifehistCont', 'HabspeCont', 'Taxa')
colnames(rodDat_trait2)[1:8] = c('species', 'Climate', 'habConf', 'habprop', 'BodySizeCont', 'FSlifehistCont', 'HabspeCont', 'Taxa')
colnames(wgDat_trait2)[1:8] = c('species', 'Climate', 'habConf', 'habprop', 'BodySizeCont', 'FSlifehistCont', 'HabspeCont', 'Taxa')

Dat_trait_all = rbind(BdDat_trait2, BfDat_trait2, mothDat_trait2, rodDat_trait2, wgDat_trait2)
head(Dat_trait_all)
...
ggternBBM = ggtern::grid.arrange(ternBirdHL, ternbuttflyHL, ternMothHL,
          ...
          ncol=3, nrow=3)
ggsave(ggternBBM, file=paste0("ggternBBM_occ",".png", sep = ""))
...
ggsave(ggternRLM, file=paste0("ggternRLM_occ",".png", sep = ""))
